...
const TEMPLATES = [
  "本日はご来院ありがとうございました。お大事になさってください。",
  "定期検診のお時間です。ご予約をお待ちしております。",
  "本日はお疲れ様でした。治療後、痛みや違和感がございましたらお気軽にご連絡ください。",
  "歯石除去が完了しました。次回は3ヶ月後の検診をおすすめします。",
  "本日お渡しした歯ブラシで、毎日丁寧にケアしてくださいね。",
];
